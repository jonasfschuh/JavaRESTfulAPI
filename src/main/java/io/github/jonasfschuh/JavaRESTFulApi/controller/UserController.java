package io.github.jonasfschuh.JavaRESTFulApi.controller;

import io.github.jonasfschuh.JavaRESTFulApi.controller.dto.UserDto;
import io.github.jonasfschuh.JavaRESTFulApi.domain.model.User;
import io.github.jonasfschuh.JavaRESTFulApi.service.UserService;
...
public record UserController(UserService userService) {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get a user by ID", description = "Retrieve a specific user base on its ID")
    @ApiResponses(value = {
    ...
    @PostMapping
    @Operation(summary = "Create a new user", description = "Create a new user and return the create user´s data")
    @ApiResponses(value = {
